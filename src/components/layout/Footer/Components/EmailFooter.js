...
import { FooterContext } from "../../../../contexts/index";
import Input from "../../../Forms/Input";
import Service from "../../../../service/index";
// import { setInputEmail } from "../../../../redux/Email/EmailSlice";
const InputEmailFooter = () => {
  // const [state, dispatchEmail] = React.useContext(FooterContext);
  ...
  return (
    <div className="container-input">
      <div className="footer-text-main">Register the course</div>
      ...
      <div className="container-footer-input">
        ...
        {/* {state.error && (
          <span className="footer-error-color">
            Invalid email format. Please try again.
          </span>
        )}
        {state.successful && (
          <span className="footer-complete-color">
